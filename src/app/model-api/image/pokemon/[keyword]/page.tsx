...
import ImgGeneration from "../../[keyword]/components/ImgGeneration";

import { Metadata } from "next";
import { CANONICAL_URL } from "@/constants/canonical";
import { getLocalizedMetadataAlternates } from "@/i18n/metadata";

const fetchUrl = "https://novita.ai/image-config-pokemon.json";
...
export async function generateMetadata(props: {
  ...
  if (!Array.isArray(configJson?.data)) {
    return {
      title: `${PRODUCT_NAME} pokemon | 404`,
  ...
  return {
    ...
    keywords: `${PRODUCT_NAME}, Stable Diffusion, pokemon generator, pokemon team builder ,${pageData.title}`,
    alternates: getLocalizedMetadataAlternates(
      CANONICAL_URL.MODEL_API_IMAGE_POKEMON + "/" + pageData.urlSlug,
    ),
  };
}
