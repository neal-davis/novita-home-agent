...
import Txt2VideoDemo from "@/app/components/demos/Txt2Video/Txt2Video";
...
export default function Case() {
  return (
    <div className={`${commonStyle.page_container} max_width_container`}>
      <h2 className={`font-h3 text-center mb-5`}>Try text to video API demo</h2>
      <div className={`font-p text-center`}>
        ...
        <a href={`${NOVITA_URL.MODEL_API_PLAYGROUND}#${FUNCS.TXT2VIDEO.name}`}>
      ...
      <CaseWrapper
        funcInfo={FUNCS.TXT2VIDEO}
        renderCase={(props) => {
          return <Txt2VideoDemo {...props} />;
        }}
      />
    </div>
  );
