  ...
  return (
    <div className={`${commonStyle.page_container} max_width_container`}>
      <h2 className={`font-h3 text-center mb-5`}>
        Try replace object API demo
      </h2>
      <div className={`font-p text-center`}>
        Replace an object in the image. Visit the{" "}
        <a
          href={`${NOVITA_URL.MODEL_API_PLAYGROUND}#${FUNCS.REPLACE_OBJECT.name}`}
        >
