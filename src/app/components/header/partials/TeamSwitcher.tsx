  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      <PopoverTrigger asChild>
        <div className="flex items-center text-ellipsis cursor-pointer border-solid border-[1px] border-[var(--gray-2)] rounded-sm px-[8px] py-[6px] font-subtle whitespace-nowrap">
