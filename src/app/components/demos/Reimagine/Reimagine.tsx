...
import styles from "./Reimagine.module.css";
import baseStyles from "../base.module.scss";
import { reimagine, getFailMsgV3 } from "@/api/api";
...
export default function Reimagine(props: DemoProps) {
  ...
  const handleGenerate = async () => {
    ...
    reimagine(
      props.apiKey,
      {
        image_file: imgSrc.split(";base64,")[1],
        extra: {
          enterprise_plan: {
