...
import styles from "./RestoreFace.module.css";
import baseStyles from "../base.module.scss";
import { restoreFace, getFailMsgV3 } from "@/api/api";
...
export default function RestoreFace(props: DemoProps) {
  ...
  useEffect(() => {
    onParamChange?.("fidelity", fidelity);
  }, [fidelity, onParamChange]);
  useEffect(() => {
      ...
      formContent={
        <>
          ...
          <Slider
            ...
            onChange={(val) => {
              setFidelity(val);
              props.onParamChange?.("fidelity", val);
            }}
            onFocus={() => {
              props.onParamFocus?.("fidelity");
            }}
            onBlur={() => {
              props.onParamBlur?.("fidelity");
            }}
          />
