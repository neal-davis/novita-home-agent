...
import styles from "./ReplaceBackground.module.css";
import baseStyles from "../base.module.scss";
import { replaceBackground, getFailMsgV3 } from "@/api/api";
...
export default function ReplaceBackground(props: DemoProps) {
  ...
  const estimatePrice = useMemo(() => {
    return calcPrice(FUNC_NAME.REPLACE_BACKGROUND).discountPrice ?? "-";
  }, []);
        ...
        <>
          ...
          <div className={baseStyles.form_item}>
            ...
            <PromptInput
              value={prompt}
              setValue={setPrompt}
              placeholder={"Description of the background you want..."}
              maxLine={4}
              onChange={(val) => {
