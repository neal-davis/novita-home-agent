...
import styles from "./date-range-picker-utc-common.module.scss";
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger
        ...
        style={style}
      >
        <span className="font-subtle-demibold text-[var(--dark-4)]">UTC+0</span>
        <span className="w-[1px] h-[12px] ml-[10px] bg-[var(--gray-1)]"></span>
